 ...
 */
public class MapPerformer2 extends Performer {

	private static final String TAG = MapPerformer2.class.getSimpleName();
	 ...
	 */
	public MapPerformer2(@NonNull final View target, @NonNull final Property<View, Float> property) {
	 ...
	 */
	public MapPerformer2(@NonNull final View target, @NonNull final Property<View, Float> property, final float start, final float end) {
	 ...
	 * 		the maximum value for the view property range.
	 */
	public MapPerformer2(@NonNull final View target, @NonNull final Property<View, Float> property, final float initialStart,
